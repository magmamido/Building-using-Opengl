...
void lights() {
	GLfloat lightPosition[] = { 0,0,5 }; //x and y and z position of light array
	GLfloat lightColor[] = { 1,1,0 };//rgb
	GLfloat ambColor[] = { 0,0,1 }; //ambient ratio sides of object el htb2a illuminated by color //assig agrb aghyr l var w ashof el effect
